<script lang="ts">
  ...
  async function handleDownload() {
    ...
    error = null;
    try {
      await api.downloadModel("gemma-4-e2b-it-q4");
      downloaded = true;
    } catch (err) {
    ...
    {#if downloaded}
      <div class="card-body">
        ...
        <div class="card-text">
          ...
          <p class="card-desc">Gemma 4 E2B is downloaded. You'll get personalized coaching during games.</p>
        </div>
      </div>
    ...
    {:else if downloading}
      <div class="card-body">
        ...
        <div class="card-text">
          ...
          <p class="card-desc">Downloading Gemma 4 E2B (~3.1 GB). This may take a few minutes.</p>
        </div>
      </div>
    ...
    {:else}
      <div class="card-body">
        ...
        <div class="card-text">
          ...
          <p class="card-size">~3.1 GB download — runs locally, no internet needed after install</p>
        </div>
      </div>
      {#if error}
      ...
      {/if}
      <div class="card-actions">
        <button class="btn-primary" onclick={handleDownload}>Download Gemma 4 E2B</button>
